  ...
  return (
    <section className="container">
      <section className="spacing-between-section">
        <h2 className="fs-2xl text-capitalize text-secondary text-center fw-bold" style={{ marginBottom: "3.25rem" }}>
          featured in
        </h2>
      ...
      <section className="row spacing-between-section">
        <div className="col-md-6 col-sm-12">
          <span className="bg-primary bg-opacity-25 text-primary text-capitalize ps-3 pe-5 py-2 rounded text-left fs-xs">
            Trust, Security, Credibility
          </span>
          <h2 className="text-capitalize text-secondary fs-2xl pt-2 mb-4 fw-bold">What's Develocity?</h2>
          <p className="fs-md mb-3">
            Develocity aspires to present its final project in four primary stages. Each stage is presented separately
            and merged in the post-final stage to create a decentralised platform, which would be distinctively in terms
        ...
        <div className="col-md-6 col-sm-12">
          <div className="circleWrapper">
            ...
            <div className="customAtom bg-white" style={{ left: "17%", bottom: "19px" }}>
            ...
            <div className="customAtom bg-white" style={{ left: "18%", top: "-3px" }}>
              <svg id="teacher" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                <path
                  id="Vector"
            ...
            <svg
              ...
              height="26"
              viewBox="0 0 26 26"
              className="position-absolute start-0 translate-middle"
              style={{ left: "0", top: "46%" }}
            >
              <defs>
                <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
            ...
            <div className="customAtom bg-white" style={{ right: "-22px", bottom: "132px" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                <g
            ...
            <div className="customAtom bg-white" style={{ right: "22%", top: "131px" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
            ...
            <div className="customAtom bg-white" style={{ left: "49%", bottom: "17%" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                <g
