...
export function Roadmap() {
  ...
  const cardInfo = [
    {
      ...
      details: [
        `${t("roadmapSection.cards.startup.subText.0")}`,
        `${t("roadmapSection.cards.startup.subText.1")}`,
        `${t("roadmapSection.cards.startup.subText.2")}`,
        `${t("roadmapSection.cards.startup.subText.3")}`,
      ],
      icon: check,
      bgColor: "#5AD2FF",
    ...
    },
    {
      ...
      details: [
        `${t("roadmapSection.cards.launch.subText.0")}`,
        `${t("roadmapSection.cards.launch.subText.1")}`,
        `${t("roadmapSection.cards.launch.subText.2")}`,
        `${t("roadmapSection.cards.launch.subText.3")}`,
        `${t("roadmapSection.cards.launch.subText.4")}`,
        `${t("roadmapSection.cards.launch.subText.5")}`,
      ],
      icon: clock,
      bgColor: "#FFD13A",
    ...
    },
    {
      ...
      details: [
        `${t("roadmapSection.cards.expansion.subText.0")}`,
        `${t("roadmapSection.cards.expansion.subText.1")}`,
        `${t("roadmapSection.cards.expansion.subText.2")}`,
        `${t("roadmapSection.cards.expansion.subText.3")}`,
        `${t("roadmapSection.cards.expansion.subText.4")}`,
        `${t("roadmapSection.cards.expansion.subText.5")}`,
      ],
      icon: "",
      bgColor: "#71E581",
    ...
    },
    {
      ...
      details: [
        `${t("roadmapSection.cards.opportunities.subText.0")}`,
        `${t("roadmapSection.cards.opportunities.subText.1")}`,
        `${t("roadmapSection.cards.opportunities.subText.2")}`,
        `${t("roadmapSection.cards.opportunities.subText.3")}`,
        `${t("roadmapSection.cards.opportunities.subText.4")}`,
      ],
      icon: "",
      bgColor: "#EC92EC",
  ...
  return (
    <>
      <div className={`direction ${styles.roadmapWrapper}`}>
        ...
        <div className={`${styles.roadmapscroll}`}>
          <section className={` ${styles.roadmapContent}`}>
            <div
              className={`d-flex justify-content-center justify-content-lg-between flex-wrap flex-md-nowrap  container ${styles.roadmapCards}`}
            >
              {cardInfo.map((el, index) => (
                <div key={index} className={`  ${styles.cardBox}`}>
                  <div className={`${styles.cardContainer}`}>
                    <div className={`${styles.stepperMobile}`}></div>
                    <Card header={el.header} key={index} details={el.details} />
                  </div>
                  <div className="position-relative  w-100 ">
                    <div className={` ${styles.Line_vr_Wrapper}`}>
                      <span
                        className={`d-inline-block text-center ${styles.line_vr}`}
                        style={{ backgroundColor: el.bgColor }}
                      ></span>
                    </div>
                    <div className="d-flex  justify-content-center ">
                      <span
                        className={`d-inline-block text-center ${styles.circle}`}
                        style={{ backgroundColor: el.bgColor }}
                      >
