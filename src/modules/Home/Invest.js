          ...
          <div className="col-md-6">
            <div className="invest-left" style={{ width: "100%", maxWidth: "450px" }}>
              <svg
                ...
                ref={investScanSVGRef}
                className={`${isInvestScanSVGVisible ? "active-animated" : ""} scan-svg`}
              >
                <defs>
              ...
              <svg viewBox="0 0 431.938 257.5">
                <defs>
                  ...
                  <filter id="Rectangle_668" x="104.501" y="23.5" width="234" height="234" filterUnits="userSpaceOnUse">
                    <feOffset dy="3" input="SourceAlpha" />
                ...
                <g
                  id="Group_3562"
                  className={`${isInvestScanSVGVisible ? "active-animated-total-scan" : ""} total-scan-svg`}
