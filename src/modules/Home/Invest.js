        ...
        <section className="container" ref={sectionContainerRef}>
          <section className="row spacing-between-section">
            <div className="col-md-6 mx-auto text-center">
              <span
                style={isInView ? fadeInUpAnimation.fadeInUp : null}
            ...
            <div className="row mx-auto">
              <div className="col-md-6">
                <div className="invest-left" style={{ width: "100%", maxWidth: "450px" }}>
                  <svg viewBox="0 0 467.5 95" style={isInView ? fadeInUpAnimation.fadeInUp : null}>
                    <defs>
                      <linearGradient
                        id="linear-gradient"
                        y1="0.107"
              ...
              <div className="col-md-6">
                ...
                <m.div initial={{ opacity: 0, x: 0, y: 100 }} animate={isInView && { opacity: 1, x: 0, y: 0 }}>
                  <m.p className="fs-md text-body-text">
                    DeFi users are always trying to find the ideal investment, and they are willing to take the risk;
                    even if they try as much as they can to reduce the risk, they won’t be able to determine the size of
                    the risk.
                  </m.p>
