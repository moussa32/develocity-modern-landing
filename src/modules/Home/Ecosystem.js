const Ecosystem = () => {
  return (
    <svg className="ecosystem-svg" viewBox="0 0 556 542">
      <defs>
        ...
        <filter id="Ellipse_189" x="442" y="235" width="144" height="144" filterUnits="userSpaceOnUse">
        ...
        <filter id="Ellipse_191" x="45" y="196" width="144" height="144" filterUnits="userSpaceOnUse">
          <feOffset input="SourceAlpha" />
        ...
        <filter id="Ellipse_192" x="288" y="319" width="144" height="144" filterUnits="userSpaceOnUse">
          <feOffset input="SourceAlpha" />
        ...
        <filter id="Ellipse_193" x="281" y="90" width="144" height="144" filterUnits="userSpaceOnUse">
          <feOffset input="SourceAlpha" />
        ...
        <filter id="Ellipse_194" x="45" y="0" width="144" height="144" filterUnits="userSpaceOnUse">
          <feOffset input="SourceAlpha" />
        ...
        <filter id="Ellipse_195" x="21" y="398" width="144" height="144" filterUnits="userSpaceOnUse">
          <feOffset input="SourceAlpha" />
      ...
      <g id="Group_3560" data-name="Group 3560" transform="translate(-1059 -222.295)">
        ...
        <text
          ...
          data-name="Develocity
Eco-system"
          transform="translate(1323 495.295)"
          fill="#6c757d"
          font-size="22"
        ...
        <g transform="matrix(1, 0, 0, 1, 1059, 222.29)" filter="url(#Ellipse_189)">
          <circle
            ...
            cy="42"
            r="42"
            transform="translate(472 265)"
            fill="url(#linear-gradient-3)"
          />
        </g>
        <g transform="matrix(1, 0, 0, 1, 1059, 222.29)" filter="url(#Ellipse_191)">
          <circle
            id="Ellipse_191-2"
            ...
            cy="42"
            r="42"
            transform="translate(75 226)"
            fill="url(#linear-gradient-3)"
          />
        </g>
        <g transform="matrix(1, 0, 0, 1, 1059, 222.29)" filter="url(#Ellipse_192)">
          <circle
            id="Ellipse_192-2"
            ...
            cy="42"
            r="42"
            transform="translate(318 349)"
            fill="url(#linear-gradient-3)"
          />
        </g>
        <g transform="matrix(1, 0, 0, 1, 1059, 222.29)" filter="url(#Ellipse_193)">
          <circle
            id="Ellipse_193-2"
            ...
            cy="42"
            r="42"
            transform="translate(311 120)"
            fill="url(#linear-gradient-3)"
          />
        </g>
        <g transform="matrix(1, 0, 0, 1, 1059, 222.29)" filter="url(#Ellipse_194)">
          <circle
            id="Ellipse_194-2"
        ...
        <g transform="matrix(1, 0, 0, 1, 1059, 222.29)" filter="url(#Ellipse_195)">
          <circle
            id="Ellipse_195-2"
        ...
        <g
          ...
          transform="translate(770 486.295)"
        >
          <g id="bitcoin-convert" transform="translate(364 188)">
            ...
            <path
              ...
              fill="#a066dc"
            />
            <path id="Vector-13" data-name="Vector" d="M0,0H36V36H0Z" fill="#a066dc" opacity="0" />
          </g>
        </g>
        <g id="vuesax_outline_bubble" data-name="vuesax/outline/bubble" transform="translate(1222 -269.705)">
          <g id="bubble" transform="translate(172 636)">
            ...
            <path
              ...
              fill="#a066dc"
            />
            <path id="Vector-17" data-name="Vector" d="M0,0H36V36H0Z" fill="none" opacity="0" />
            <path id="Vector-18" data-name="Vector" d="M0,0H36V36H0Z" fill="none" opacity="0" />
          </g>
        </g>
        <g id="vuesax_outline_format-square" data-name="vuesax/outline/format-square" transform="translate(922 92.295)">
          <g id="format-square" transform="translate(236 380)">
            ...
            <path
              ...
              fill="#a066dc"
            />
            <path id="Vector-24" data-name="Vector" d="M0,0H36V36H0Z" fill="none" opacity="0" />
          </g>
        </g>
        <g id="vuesax_outline_scan-barcode" data-name="vuesax/outline/scan-barcode" transform="translate(1127 259.295)">
          <g id="scan-barcode" transform="translate(428 252)">
            ...
            <path
              ...
              fill="#a066dc"
            />
            <path id="Vector-33" data-name="Vector" d="M0,0H36V36H0Z" fill="none" opacity="0" />
          </g>
        </g>
        <g id="vuesax_outline_wallet-money" data-name="vuesax/outline/wallet-money" transform="translate(1293 215.295)">
